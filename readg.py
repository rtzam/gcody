...
def read(file=None, text=None, n_lines=100000):
    '''
    Parameters:

    > FILE: if a file is given, then it is read from
    > TEXT: a list where each element is each line of GCODE
    ...
    # through
    code = gcode(preallocate=n_lines)
